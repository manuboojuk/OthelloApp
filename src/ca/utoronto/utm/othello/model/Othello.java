...
public class Othello extends Observable {
	...
	public String hintType = "Random"; //hint is default set to random
	public boolean alwaysShowHint = false;
	...
	/**
	 * 
	 * @param hintType string that says which type is hint is desired
	 * @return Move object that gives the coordinated of the hint
	 */
	public Move getHint() {
		if (this.hintType == "Random") {
			RandomStrategy randomStrat = new RandomStrategy();
			Move randHint = randomStrat.getMove(this, this.getWhosTurn());
			return randHint;	
		}
		else if (this.hintType == "Advanced") {
			AdvancedStrategy advancedStrat = new AdvancedStrategy();
			Move advHint = advancedStrat.getMove(this, this.getWhosTurn());
			return advHint;		
		}
		else {
			GreedyStrategy greedyStrat = new GreedyStrategy();
			Move greedyHint = greedyStrat.getMove(this, this.getWhosTurn());
			return greedyHint;		
		}
	}
